...
void Scene::LoadDefaultScene()
{
  ...
  // top Light
  objects[2].material = Material(ReflectionType::specular, ColorD(0.0, 0.0, 0.0), ColorD(0.75, 0.75, 0.75), 0.5, 0.5);
  ...
  // bottom Light
  objects[3].material = Material(ReflectionType::specular, ColorD(0.0, 0.0, 0.0), ColorD(0.4, 0.4, 0.4), 0.5, 0.5);
  ...
  // Right
  objects[4].material = Material(ReflectionType::diffuse, ColorD(0.9, 0, 0), ColorD(), 1.0, 0.0);
  ...
  // Left
  objects[5].material = Material(ReflectionType::diffuse, ColorD(0, 0, 0.9), ColorD(), 1.0, 0.0);
  ...
  // Back
  objects[6].material = Material(ReflectionType::diffuse, ColorD(0.5, 0.5, 0.5), ColorD(), 1.0, 0.0);
  ...
  // Top
  objects[7].material = Material(ReflectionType::diffuse, ColorD(0.0, 0.9, 0.0), ColorD(), 1.0, 0.0);
  ...
  // Bottom
  objects[8].material = Material(ReflectionType::diffuse, ColorD(0.5, 0.5, 0.0), ColorD(), 1.0, 0.0);
